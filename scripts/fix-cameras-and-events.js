    ...
    try {
        ...
        const eventTemplates = {
            incidenti: [
                ...
                {
                    title: "Incidente lieve",
                    description: "Collisione senza feriti",
                    severity: "basso",
                },
                {
        ...
        for (let i = 0; i < 7; i++) {
            ...
            const nearbyCoords = {
                lat: parseFloat(
                    (camera.location.coordinates.lat + (Math.random() - 0.5) * 0.003).toFixed(6)
                ),
                lng: parseFloat(
                    (camera.location.coordinates.lng + (Math.random() - 0.5) * 0.004).toFixed(6)
                ),
            };
