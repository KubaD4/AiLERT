...
const EVENTI_TEST = [
    // Incidenti
    {
        title: "Incidente Via Roma",
        description: "Tamponamento auto-moto",
        severity: "alta",
        type: "incidente",
    },
    {
        title: "Scontro Corso Italia",
        description: "Collisione tra due auto",
        severity: "media",
        type: "incidente",
    },
    {
        title: "Incidente Via Kennedy",
        description: "Auto fuori strada",
        severity: "alta",
        type: "incidente",
    },
    {
        title: "Tamponamento Tangenziale",
        description: "Catena di tamponamenti",
        severity: "alta",
        type: "incidente",
    },
    {
        title: "Investimento Duomo",
        description: "Pedone investito sulle strisce",
        severity: "alta",
        type: "incidente",
    },
    {
        title: "Ribaltamento A22",
        description: "Auto ribaltata in autostrada",
        severity: "alta",
        type: "incidente",
    },
    {
        title: "Scontro Via Manci",
        description: "Incidente tra moto e bici",
        severity: "media",
        type: "incidente",
    },
    {
        title: "Uscita strada SS12",
        description: "Auto finita nel fossato",
        severity: "media",
        type: "incidente",
    },
    {
        title: "Collisione Stazione",
        description: "Incidente davanti alla stazione",
        severity: "alta",
        type: "incidente",
    },
    {
        title: "Tamponamento Centro",
        description: "Scontro in centro città",
        severity: "bassa",
        type: "incidente",
    },
    ...
    // Ingorghi
    {
        title: "Ingorgo Ponte San Lorenzo",
        description: "Traffico intenso sul ponte",
        severity: "media",
        type: "ingorgo",
    },
    {
        title: "Rallentamenti Centro",
        description: "Traffico da evento",
        severity: "bassa",
        type: "ingorgo",
    },
    {
        title: "Blocco Via Brennero",
        description: "Lavori stradali in corso",
        severity: "media",
        type: "ingorgo",
    },
    {
        title: "Coda Autostrada A22",
        description: "Code al casello Trento Sud",
        severity: "alta",
        type: "ingorgo",
    },
    {
        title: "Traffico Università",
        description: "Orario di punta studenti",
        severity: "bassa",
        type: "ingorgo",
    },
    {
        title: "Blocco Piazza Fiera",
        description: "Evento in corso, traffico deviato",
        severity: "alta",
        type: "ingorgo",
    },
    {
        title: "Rallentamenti Tangenziale",
        description: "Code in tangenziale",
        severity: "media",
        type: "ingorgo",
    },
    {
        title: "Ingorgo Via Pranzelores",
        description: "Traffico intenso zona commerciale",
        severity: "media",
        type: "ingorgo",
    },
    {
        title: "Blocco Trasporto Pubblico",
        description: "Autobus fermo per guasto",
        severity: "alta",
        type: "ingorgo",
    },
    {
        title: "Code Centro Storico",
        description: "ZTL attiva, traffico lento",
        severity: "bassa",
        type: "ingorgo",
    },
];
    ...
    try {
        ...
        for (let i = 0; i < EVENTI_TEST.length; i++) {
            ...
            if (i < 2) {
                ...
                console.log(
                    `   Timestamp: ${eventTime.toLocaleTimeString()} (${minutesAgo} min fa)`
                );
            } else {
                const delayMinutes = Math.round((eventTime.getTime() - now.getTime()) / 60000);
                console.log(`${i + 1}. ${evento.title} (${evento.type}) - FUTURO`);
                console.log(
                    `   Timestamp: ${eventTime.toLocaleTimeString()} (tra ${delayMinutes} min)`
                );
            }
        }
        ...
        nextEvents.forEach((event, index) => {
            ...
            console.log(
                `${index + 1}. ${event.title} - tra ${secondi}s (~${minuti}min) - ${event.eventDate.toLocaleTimeString()}`
            );
        });
    } catch (error) {
