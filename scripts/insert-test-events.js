...
async function clearAndInsertTestData() {
    try {
        ...
        const testEvents = [
            ...
            // Aggiungiamo eventi extra per testare più punti sulla mappa
            {
                type: 'incidente',
        ...
        // 5. Verifica cosa restituisce l'API pubblica
