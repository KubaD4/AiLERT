...
async function cleanDatabase() {
    try {
        ...
        console.log(
            `   Totale documenti: ${beforeStats.cameras + beforeStats.streams + beforeStats.events}`
        );
        ...
        console.log(
            `   Totale cancellati: ${eventsResult.deletedCount + streamsResult.deletedCount + camerasResult.deletedCount}`
        );
    } catch (error) {
