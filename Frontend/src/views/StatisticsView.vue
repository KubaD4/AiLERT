...
const totalIncidents = computed(
  () => filteredEvents.value.filter(e => e.type === "incidente").length || 0
);
const totalTrafficJams = computed(
  () => filteredEvents.value.filter(e => e.type === "ingorgo").length || 0
);
const activeEvents = computed(
  () => filteredEvents.value.filter(e => ["pending", "unsolved"].includes(e.status)).length || 0
);
...
function generateMockCameras() {
  return [
    {
      _id: "68266cd1683978f9108a7393",
      cameraId: "68266cd1683978f9108a7393",
      streamKey: "stream_test_manuale",
    },
    {
      _id: "68266da2683978f9108a7395",
      cameraId: "68266da2683978f9108a7395",
      streamKey: "stream_vanga",
    },
    {
      _id: "68266da2683978f9108a7396",
      cameraId: "68266da2683978f9108a7396",
      streamKey: "stream_dante",
    },
    {
      _id: "68266da2683978f9108a7397",
      cameraId: "68266da2683978f9108a7397",
      streamKey: "stream_santachiara",
    },
    {
      _id: "682880cf683978f9108a739b",
      cameraId: "682880cf683978f9108a739b",
      streamKey: "stream_duomo",
    },
  ];
}
</script>
    ...
    > <div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 mb-8"
      > <div class="max-w-7xl mx-auto relative"
        > <div class="text-center"
          > <h1 class="text-3xl font-bold mb-2">Statistiche Eventi</h1> <p class="opacity-80"
            >Analisi dettagliata degli eventi stradali di Trento</p
          > </div
        > </div
      > </div
    > <div class="max-w-7xl mx-auto px-4 pb-12"
      > <DashboardNav /> <div class="bg-white rounded-2xl shadow-md p-6 mb-8 border border-gray-100"
        > <h2 class="text-xl font-bold text-gray-900 mb-6">Filtri</h2> <div
          ...
          > <div
            ...
            > <div class="flex flex-wrap gap-4 items-end"
              > <div class="space-y-2"
                > <label class="block text-sm font-medium text-gray-700">Data inizio</label> <input
                  type="date"
                  v-model="startDate"
                ...
                /> </div
              > <div class="space-y-2"
                > <label class="block text-sm font-medium text-gray-700">Data fine</label> <input
                  type="date"
                  v-model="endDate"
                  class="w-48 px-4 py-2 bg-white border border-gray-300 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none"
                /> </div
      ...
      > <div v-if="loading" class="flex justify-center py-12"
        > <div class="flex flex-col items-center"
          > <div
            ...
            > </div
          > <p class="text-gray-600">Caricamento statistiche...</p> </div
        > </div
      > <div
        v-else-if="error"
        class="bg-red-50 border border-red-200 text-red-700 p-6 rounded-xl mb-8"
      ...
      > <div v-else
          ...
          > <div class="bg-white rounded-2xl shadow-md p-6 border border-blue-100"
            > <div class="flex items-center mb-3"
              > <div class="bg-blue-100 p-3 rounded-lg mr-3"
                ...
                > </div
              > <span class="text-gray-700 font-medium">Eventi Totali</span> </div
          ...
          > <div class="bg-white rounded-2xl shadow-md p-6 border border-red-100"
            > <div class="flex items-center mb-3"
              > <div class="bg-red-100 p-3 rounded-lg mr-3"
                ...
                > </div
              > <span class="text-gray-700 font-medium">Incidenti</span> </div
          ...
          > <div class="bg-white rounded-2xl shadow-md p-6 border border-orange-100"
            > <div class="flex items-center mb-3"
              > <div class="bg-orange-100 p-3 rounded-lg mr-3"
                ...
                > </div
              > <span class="text-gray-700 font-medium">Ingorghi</span> </div
          ...
          > <div class="bg-white rounded-2xl shadow-md p-6 border border-green-100"
            > <div class="flex items-center mb-3"
              > <div class="bg-green-100 p-3 rounded-lg mr-3"
                ...
                > </div
              > <span class="text-gray-700 font-medium">Eventi Attivi</span> </div
            > <div class="text-3xl font-bold text-green-600">{{ activeEvents }}</div
            > </div
          > </div
        > <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8"
          > <div class="bg-white rounded-2xl shadow-md p-6 border border-gray-100"
            > <h2 class="text-xl font-bold text-gray-900 mb-6 pb-2 border-b"
              >Distribuzione per Tipo di Evento </h2
            > <EventTypeDistribution :events="filteredEvents" /> </div
          > <div class="bg-white rounded-2xl shadow-md p-6 border border-gray-100"
            > <h2 class="text-xl font-bold text-gray-900 mb-6 pb-2 border-b"
              >Distribuzione per Gravità</h2
            > <SeverityDistribution :events="filteredEvents" /> </div
          > </div
        > <div class="bg-white rounded-2xl shadow-md p-6 mb-8 border border-gray-100"
          > <h2 class="text-xl font-bold text-gray-900 mb-6 pb-2 border-b"
            >Andamento Eventi nel Tempo</h2
          > <EventTimeTrend
        ...
        > <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8"
          > <div class="bg-white rounded-2xl shadow-md p-6 border border-gray-100"
            > <h2 class="text-xl font-bold text-gray-900 mb-6 pb-2 border-b"
              >Distribuzione Oraria degli Eventi </h2
            > <HourlyDistribution :events="filteredEvents" /> </div
          > <div class="bg-white rounded-2xl shadow-md p-6 border border-gray-100"
            > <h2 class="text-xl font-bold text-gray-900 mb-6 pb-2 border-b"
              >Distribuzione per Stato</h2
            > <EventStatusDistribution :events="filteredEvents" /> </div
          > </div
        > <div class="bg-white rounded-2xl shadow-md p-6 mb-8 border border-gray-100"
          > <h2 class="text-xl font-bold text-gray-900 mb-6 pb-2 border-b">Eventi per Telecamera</h2
          > <EventsByCamera :events="filteredEvents" :cameras="cameras" /> </div
        > </div
      > </div
    > </div
  >
