  ...
  <div class="min-h-screen bg-base-100">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8">
      <div class="max-w-7xl mx-auto">
        ...
        <p class="opacity-80">Gestione utenti e configurazione del sistema</p>
      </div>
    </div>
    ...
    <div class="bg-white shadow-md">
      <div class="max-w-7xl mx-auto flex overflow-x-auto">
        <router-link 
          ...
          :class="$route.name === 'admin-users' || $route.name === 'admin-user-create' || $route.name === 'admin-user-detail' || $route.name === 'admin-user-edit' ? 'border-blue-600 text-blue-600' : 'border-transparent'"
        >
          Gestione Utenti
        </router-link>
      </div>
    ...
    <div class="max-w-7xl mx-auto p-6">
      <router-view :key="dataRefreshTrigger" />
    </div>
  </div>
</template>
