...
<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
    ...
    <div class="absolute inset-0 opacity-5 overflow-hidden">
      ...
      <svg class="absolute bottom-20 right-20 w-40 h-40" viewBox="0 0 100 100" fill="currentColor">
    ...
    <div class="relative w-full max-w-md">
      ...
      <div class="bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl border border-white/20 p-8 transform transition-all duration-300 hover:shadow-2xl">
        ...
        <div class="text-center mb-8">
          ...
          <h2 class="text-2xl font-bold text-gray-900">Cambia Password</h2>
          <p class="text-gray-600 mt-2">Ciao {{ userName }}, inserisci una nuova password</p>
        </div>
        ...
        <div class="mt-8 bg-blue-50 rounded-xl p-3 border border-blue-100">
          <p class="text-sm text-blue-800">
            <span class="font-medium">Suggerimento di sicurezza:</span> Usa una password di almeno 8 caratteri con lettere, numeri e simboli speciali.
          </p>
        </div>
      </div>
    </div>
