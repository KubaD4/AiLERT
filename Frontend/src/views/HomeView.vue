...
// Apri/chiudi il popup della guida
const toggleGuide = () => {
      ...
      <div class="relative max-w-7xl mx-auto px-4 pt-20 pb-32">
        <div class="text-center">
          ...
          <div class="flex flex-wrap justify-center items-center space-x-6">
            ...
            <button v-if="!isLoggedIn" @click="toggleGuide"
              ...
              <span class="relative z-10">Guida Rapida</span>
            </button>

            <button v-else @click="navigateToDashboard"
              class="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl hover:shadow-xl hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div class="relative">
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-8 h-full">
              ...
              <p class="text-gray-600">Le telecamere analizzano il traffico in tempo reale con algoritmi di computer
                vision avanzati</p>
            </div>
          </div>
          ...
          <div class="relative">
            <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-3xl p-8 h-full">
              ...
              <p class="text-gray-600">I sorveglianti confermano gli incidenti e allertano automaticamente i servizi di
                emergenza</p>
            </div>
          </div>
          ...
          <div class="relative">
            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-3xl p-8 h-full">
              ...
              <p class="text-gray-600">I cittadini ricevono aggiornamenti in tempo reale sullo stato del traffico
                cittadino</p>
            </div>
          </div>
        </div>
  ...
  <div class="max-w-7xl mx-auto px-4">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div class="text-center group">
        ...
        <p class="text-gray-600">Degli incidenti notificati</p>
      </div>
    </div>
  </div>
</section>
    ...
    <QuickGuide :is-open="isGuideOpen" @close="closeGuide" />
  </div>
</template>