...
const cameraEvents = computed(() => {
  ...
  return events.value
    .filter(event => event.cameraId === stream.value.cameraId)
    ...
    > <div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 mb-8"
      > <div class="max-w-7xl mx-auto"
        > <div class="flex items-center"
          > <button
            @click="goBack"
            class="mr-4 bg-white/20 hover:bg-white/30 rounded-full p-2 transition-colors"
            > <svg
          ...
          > <div
            > <h1 class="text-3xl font-bold mb-2">{{
              stream ? stream.streamKey : "Dettaglio Telecamera"
            }}</h1
            > <p class="opacity-80">Visualizzazione live e dettagli della telecamera</p> </div
          > </div
        > </div
      > </div
    > <div class="max-w-7xl mx-auto px-4"
      > <div v-if="!loading && stream" class="flex justify-end mb-6"
        > <button
          ...
          > {{ loadingEvents ? "Aggiornamento..." : "Aggiorna eventi" }} </button
        > </div
      > <div v-if="loading" class="bg-white rounded-2xl shadow-md p-12 text-center mb-8"
        ...
        ></div
        > <p class="text-lg text-gray-600">Caricamento stream...</p> </div
      > <div
        v-else-if="error"
      ...
      > <div v-else-if="!stream" class="bg-white rounded-2xl shadow-md p-12 text-center mb-8"
        > <p class="text-lg text-gray-600">Stream non trovato.</p> </div
      > <div v-else
            ...
            > <div class="space-y-4"
              > <div class="flex items-center"
                > <div class="w-8 h-8 bg-blue-50 rounded-lg flex items-center justify-center mr-3"
                  ...
                  > </div
                > <div
                  > <div class="text-sm text-gray-500">ID Stream</div> <div class="font-mono">{{
                    stream._id
                  }}</div
                  > </div
                > </div
              > <div class="flex items-center"
                > <div class="w-8 h-8 bg-purple-50 rounded-lg flex items-center justify-center mr-3"
                  ...
                  > </div
                > <div
                  > <div class="text-sm text-gray-500">ID Camera</div> <div class="font-mono">{{
                    stream.cameraId
                  }}</div
                  > </div
                > </div
              > <div class="flex items-center"
                > <div class="w-8 h-8 bg-green-50 rounded-lg flex items-center justify-center mr-3"
                  ...
                  > </div
                > <div
                  > <div class="text-sm text-gray-500">Stream Key</div> <div>{{
                    stream.streamKey
                  }}</div
                  > </div
                > </div
              > <div class="flex items-center"
                > <div class="w-8 h-8 bg-indigo-50 rounded-lg flex items-center justify-center mr-3"
                  ...
                  > </div
                > <div
                  > <div class="text-sm text-gray-500">URL</div> <div
              ...
              > <div class="flex items-center"
                > <div class="w-8 h-8 bg-amber-50 rounded-lg flex items-center justify-center mr-3"
                  ...
                  > </div
                > <div
                  > <div class="text-sm text-gray-500">Tipo</div> <div>{{ stream.streamType }}</div
                  > </div
                > </div
              > <div class="flex items-center"
                > <div class="w-8 h-8 bg-teal-50 rounded-lg flex items-center justify-center mr-3"
                  ...
                  > </div
                > <div
                  > <div class="text-sm text-gray-500">Attivo</div> <div class="flex items-center"
                    > <span
                      class="inline-block w-3 h-3 rounded-full mr-2"
                      :class="stream.isActive ? 'bg-green-500' : 'bg-red-500'"
                    ></span
                    > {{ stream.isActive ? "Sì" : "No" }} </div
                  > </div
                > </div
              > <div class="flex items-center"
                > <div class="w-8 h-8 bg-rose-50 rounded-lg flex items-center justify-center mr-3"
                  ...
                  > </div
                > <div
                  > <div class="text-sm text-gray-500">Inizio</div> <div>{{
              ...
              > <div v-if="stream.endTime" class="flex items-center"
                > <div class="w-8 h-8 bg-red-50 rounded-lg flex items-center justify-center mr-3"
                  ...
                  > </div
                > <div
                  > <div class="text-sm text-gray-500">Fine</div> <div>{{
              ...
              > <div class="flex items-center"
                > <div class="w-8 h-8 bg-cyan-50 rounded-lg flex items-center justify-center mr-3"
                  ...
                  > </div
                > <div
                  > <div class="text-sm text-gray-500">Visualizzazioni</div> <div>{{
                    stream.viewCount
                  }}</div
                  > </div
                > </div
        ...
        > <div class="bg-white rounded-2xl shadow-md p-6 mb-8"
          > <h2 class="text-xl font-bold text-gray-900 mb-6 pb-3 border-b border-gray-100"
            > Eventi recenti su questa telecamera </h2
          > <div v-if="loadingEvents" class="text-center py-6"
            > <div
              class="inline-block animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-blue-600 mb-2"
            ></div
            > <p class="text-gray-600">Caricamento eventi...</p> </div
            ...
            > <div
              ...
              :class="{
                'border-red-200 bg-red-50':
                  event.type === 'incidente' && ['pending', 'unsolved'].includes(event.status),
                'border-orange-200 bg-orange-50':
                  event.type === 'ingorgo' && ['pending', 'unsolved'].includes(event.status),
              ...
              > <div v-if="event.notifiedServices && event.notifiedServices.length > 0" class="mb-3"
                > <div class="text-sm font-medium text-gray-600 mb-1">Servizi allertati:</div> <div
                  ...
                  > </div
                > </div
              > <EventActionControls :event="event" :onEventUpdated="handleEventUpdated" /> </div
            > </div
          > </div
        > </div
      > </div
