...
<template>
  <div v-show="isOpen" class="fixed inset-0 z-[100] overflow-auto" style="pointer-events: none">
    <div class="flex justify-center min-h-screen p-4 pt-20" style="pointer-events: none">
      <div
      ...
      ></div>
      <div
        class="bg-white rounded-xl shadow-xl p-6 md:p-8 max-w-4xl w-full h-fit mt-8 relative z-[101] border border-gray-200 ring-1 ring-gray-200 shadow-2xl transition-all duration-300 ease-in-out"
        ...
        <div class="space-y-6 text-gray-600">
          ...
          <section>
            ...
            <p>
              ...
              eventi sono rappresentati con colori diversi in base alla tipologia:
            </p>
          ...
          <section>
            ...
            <p>
              ...
              al sistema completo tramite il pulsante "Accedi" in alto a destra.
            </p>
          </section>
        </div>
