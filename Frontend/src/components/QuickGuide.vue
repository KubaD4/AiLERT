        ...
        > <div class="space-y-6 text-gray-600"
          ...
          > <section
            > <h3 class="text-xl font-semibold text-gray-800 mb-2">Visualizzazione Eventi</h3> <p
              > Sulla homepage puoi visualizzare gli eventi stradali recenti (ultimi 120 minuti).
              Gli eventi sono rappresentati con colori diversi in base alla tipologia: </p
