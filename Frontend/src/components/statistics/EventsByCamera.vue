...
<template>
   <div
    > <div
      v-if="events.length === 0 || !eventsByCamera.length"
      class="flex items-center justify-center h-64"
      > <p class="text-gray-500 text-lg">Nessun dato disponibile per le telecamere</p> </div
    > <div v-else
        ...
        > <div
          ...
          > <div class="flex items-center justify-between"
            > <div class="flex items-center space-x-3"
              > <div
                class="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-full flex items-center justify-center font-bold"
                > {{ index + 1 }} </div
              > <div
      ...
      > <div class="bg-white rounded-xl p-6 border border-gray-200 shadow-sm mb-6"
          ...
          > <div v-for="(camera, index) in eventsByCamera" :key="index" class="mb-4"
            > <div class="flex justify-between items-center mb-1"
              > <div class="font-medium truncate max-w-md flex items-center"
                > <span
                  class="w-6 h-6 bg-blue-100 text-blue-700 rounded-full flex items-center justify-center text-xs font-bold mr-2"
                  > {{ index + 1 }} </span
                > {{ camera.name }} </div
            ...
            > <div class="h-7 bg-gray-100 rounded-lg overflow-hidden flex relative"
              > <div
                ...
                > <span
                  v-if="camera.incidenti > 1"
                  class="text-white text-xs font-semibold px-2 z-10"
                  >{{ camera.incidenti }}</span
                > </div
              > <div
                v-if="camera.ingorghi > 0"
                ...
                > <span
                  v-if="camera.ingorghi > 1"
                  class="text-white text-xs font-semibold px-2 z-10"
                  >{{ camera.ingorghi }}</span
                > </div
              > </div
            > </div
          > </div
        > <div class="flex items-center justify-center space-x-6 mt-6"
          > <div class="flex items-center"
            > <div class="w-4 h-4 bg-red-500 rounded-md mr-2"></div> <span class="text-sm"
              >Incidenti</span
            > </div
          > <div class="flex items-center"
            > <div class="w-4 h-4 bg-orange-500 rounded-md mr-2"></div> <span class="text-sm"
              >Ingorghi</span
            > </div
          > </div
        > </div
