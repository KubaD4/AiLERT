...
<template>
   <div class="bg-white rounded-2xl shadow-md p-6"
    > <h2 class="text-xl font-bold text-gray-900 mb-6">Distribuzione Oraria degli Eventi</h2> <div
    ...
    > <div v-else
      > <div class="h-64 relative pt-8 pb-8 px-4 flex items-end justify-between border-b border-l"
        > <div class="absolute left-0 top-0 bottom-0 w-px bg-gray-300"></div> <div
          class="absolute left-0 right-0 bottom-0 h-px bg-gray-300"
        ></div
        > <div class="absolute left-0 right-0 top-1/4 h-px bg-gray-100"></div> <div
          class="absolute left-0 right-0 top-1/2 h-px bg-gray-100"
        ></div
        > <div class="absolute left-0 right-0 top-3/4 h-px bg-gray-100"></div> <div
      ...
      > <div class="flex justify-center space-x-6 mt-8"
        ...
        > </div
      > <div class="mt-6"
        > <h3 class="text-sm font-semibold text-gray-700 mb-2">Ore di punta:</h3> <div
