...
<template>
   <div class="bg-white rounded-2xl shadow-md p-6"
    > <h2 class="text-xl font-bold text-gray-900 mb-6">Distribuzione per Gravità</h2> <div
        ...
        > <div
          ...
          > <div class="flex justify-between items-center"
            ...
            > <div
              ...
              > {{ severityPercentages[item.name] }}% </div
            > </div
          > <div
            ...
            <template v-if="totalSeverity > 0">
              ...
              <template v-for="(item, index) in severityData" :key="item.name">
                ...
                <template v-if="item.value > 0">
                  ...
                  <path :d="getPieSegment(index, severityPercentages)" :fill="item.color" />
