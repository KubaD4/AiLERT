...
<template>
   <div
    ...
    > <div
      v-else
      class="h-64 relative pt-4 px-12 pb-12 border-b border-l bg-white rounded-xl shadow-sm"
      > <div class="absolute left-0 top-0 bottom-12 w-10 flex flex-col justify-between"
        > <div v-for="(tick, i) in yAxisTicks" :key="i" class="flex items-center"
          ...
          > <div class="w-2 h-px bg-gray-300"></div> </div
        > </div
      > <div
        ...
        > </div
      > <div class="absolute left-10 top-0 bottom-0 w-px bg-gray-300"></div> <div
        class="absolute left-10 right-0 bottom-0 h-px bg-gray-300"
      ></div
    ...
    > <div class="flex justify-center space-x-6 mt-8"
      > <div class="flex items-center"
        > <div class="w-4 h-4 bg-blue-600 rounded-full mr-2"></div> <span class="text-sm"
          >Totale</span
        > </div
      > <div class="flex items-center"
    ...
    > <div class="grid grid-cols-3 gap-4 mt-8"
      > <div class="bg-blue-50 rounded-lg p-3 text-center border border-blue-100"
        > <div class="text-sm text-gray-600">Totale eventi</div> <div
          class="text-xl font-bold text-blue-700"
          > {{ trendData.reduce((acc, curr) => acc + curr.total, 0) }} </div
        > </div
      > <div class="bg-red-50 rounded-lg p-3 text-center border border-red-100"
        > <div class="text-sm text-gray-600">Incidenti</div> <div
          class="text-xl font-bold text-red-700"
          > {{ trendData.reduce((acc, curr) => acc + curr.incidenti, 0) }} </div
        > </div
      > <div class="bg-orange-50 rounded-lg p-3 text-center border border-orange-100"
        > <div class="text-sm text-gray-600">Ingorghi</div> <div
          class="text-xl font-bold text-orange-700"
          > {{ trendData.reduce((acc, curr) => acc + curr.ingorghi, 0) }} </div
        > </div
      > </div
    > </div
  >
