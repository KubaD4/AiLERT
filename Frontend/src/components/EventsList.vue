...
<template>
  <div class="px-6 py-4">
    <AlertMessage v-if="error" :message="error" type="error" class="mb-4" />
    ...
    <div v-if="events.length > 0" class="mb-6 text-sm text-gray-600 bg-gray-50 p-4 rounded-lg">
      ...
      {{ Math.min(currentPage * eventsPerPage, events.length) }} di {{ events.length }} eventi
    </div>
      ...
      >
        ...
        <div class="mb-4">
          <div v-if="editingEventId !== event._id">
            ...
            <p v-else class="text-gray-400 italic">Nessuna descrizione</p>
          </div>
          ...
          <div v-else class="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <div class="flex justify-end space-x-2 mt-3">
              ...
              >
                ...
                {{ savingDescription ? "Salvando..." : "Salva" }}
              </button>
            </div>
          </div>
        </div>
        ...
        <div class="flex justify-center space-x-3">
          ...
          <div v-if="canResolveEvent(event)">
            ...
            <div v-else class="bg-green-50 border border-green-200 rounded-lg p-4">
              <h4 class="font-medium text-green-800 mb-2">Conferma risoluzione</h4>
              <p class="text-sm text-green-700 mb-4">
                Sei sicuro di voler contrassegnare questo evento come risolto?
              </p>
              <div class="flex justify-center space-x-2">
                ...
                >
                  ...
                  {{ resolvingEventId === event._id ? "Salvando..." : "Conferma" }}
                </button>
                <button
                  @click="toggleResolveControls(event._id)"
                  :disabled="resolvingEventId === event._id"
          ...
          <div v-else-if="event.status === 'solved'" class="flex items-center text-green-600 bg-green-50 px-3 py-2 rounded-lg">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 mr-2"
              fill="none"
            ...
            <span class="text-sm font-medium">Evento risolto</span>
          </div>

          <div v-else-if="isEventNotConfirmed(event)" class="flex items-center text-orange-600 bg-orange-50 px-3 py-2 rounded-lg">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 mr-2"
              fill="none"
            ...
            <div class="flex flex-col items-center text-center">
              <span class="text-sm font-medium">Evento non ancora confermato:</span>
              <span class="text-sm font-medium">impossibile contrassegnare come risolto</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div v-else-if="!error && events.length === 0" class="text-center py-16 mx-4">
      <div class="text-gray-500">
        ...
        <p class="text-lg font-medium">Nessun evento trovato</p>
        <p class="text-sm">Non ci sono eventi da visualizzare al momento.</p>
      </div>
    </div>
