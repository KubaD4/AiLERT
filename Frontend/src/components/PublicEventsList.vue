  ...
  <div class="py-8">
    <div class="mb-8 flex justify-center">
      <div
        ...
        <div class="flex">
          <button @click="changeFilter('recent')"
            ...
            <div v-if="activeFilter === 'recent'"
              class="absolute inset-0 bg-gradient-to-r from-blue-600 to-purple-600 rounded-l-lg shadow-sm"></div>
          ...
          <button @click="changeFilter('severity')"
            class="flex-1 py-2.5 text-sm font-medium focus:outline-none relative min-w-[120px]">
            <!-- Sfondo base dei bottoni -->
            <div class="absolute inset-0 bg-gray-100/80 rounded-r-lg"></div>
            <!-- Indicatore attivo (visibile solo se selezionato) -->
            <div v-if="activeFilter === 'severity'"
              class="absolute inset-0 bg-gradient-to-r from-purple-600 to-blue-600 rounded-r-lg shadow-sm"></div>
            <!-- Testo con z-index più alto per stare sopra gli sfondi -->
    ...
    <AlertMessage v-else-if="error" :message="error" type="error" class="mb-8" />
      ...
      <div v-for="event in filteredEvents" :key="event._id"
        ...
        <div class="flex items-center justify-between mb-6">
          <div class="flex items-center space-x-2">
            ...
            <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold border" :class="[
        ...
        <div v-if="event.severity" class="mb-5">
          <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold border" :class="[
    ...
    <div class="text-center mt-12">
      <button @click="fetchPublicEvents"
